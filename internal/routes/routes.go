...
func addRoutes(
	...
	mux.Handle("POST /pages/approval/{id}/update", browserAuthn(editorAuthz(handler.UpdatePageReview(pageUseCases, logger))))
	mux.Handle("POST /pages/approval/{id}/cancel", browserAuthn(editorAuthz(handler.CancelPageReview(pageUseCases, logger))))
