...
func TestPublicViewData(t *testing.T) {
	...
	views := &Views{
		...
		runtime:      RuntimeInfo{PublicURL: "https://lore.example.test"},
	}
...
func (viewDataSettingsStub) SaveRenderingSettings(context.Context, domain.RenderingSettings, int64) error {
	return nil
}
