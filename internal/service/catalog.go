...
func (s *Catalog) Favorites(ctx context.Context, userID int64) ([]model.Page, error) {
	return s.repository.Favorites(ctx, userID)
}

// Backlinks returns active pages linking to the supplied slug.
func (s *Catalog) Backlinks(ctx context.Context, slug string) ([]model.Page, error) {
	return s.repository.Backlinks(ctx, slug)
}

// PageLinks returns outgoing and incoming link metadata for a page.
func (s *Catalog) PageLinks(ctx context.Context, slug string) ([]model.PageLink, error) {
...
func (s *Catalog) PageInventory(ctx context.Context) ([]model.Page, error) {
	return s.repository.PageInventory(ctx)
}

// PageComments returns discussion comments attached to a page.
func (s *Catalog) PageComments(ctx context.Context, slug string) ([]model.PageComment, error) {
