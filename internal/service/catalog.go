...
type catalogRepository interface {
	...
	ListPages(context.Context, int) ([]Page, error)
	Search(context.Context, string, int) ([]Page, error)
	RecentViewed(context.Context, int64, int) ([]Page, error)
	RecentEdited(context.Context, int64, int) ([]RecentEdit, error)
	Popular(context.Context, int) ([]Page, error)
	...
	Favorites(context.Context, int64) ([]Page, error)
	...
	PageInventory(context.Context) ([]Page, error)
	PageComments(context.Context, string) ([]PageComment, error)
...
func (s *Catalog) Favorites(ctx context.Context, userID int64) ([]Page, error) {
	return s.repository.Favorites(ctx, userID)
}

// Backlinks returns active pages linking to the supplied slug.
func (s *Catalog) Backlinks(ctx context.Context, slug string) ([]Page, error) {
	return s.repository.Backlinks(ctx, slug)
}

// PageLinks returns outgoing and incoming link metadata for a page.
func (s *Catalog) PageLinks(ctx context.Context, slug string) ([]PageLink, error) {
...
func (s *Catalog) PageInventory(ctx context.Context) ([]Page, error) {
	return s.repository.PageInventory(ctx)
}

// PageComments returns discussion comments attached to a page.
func (s *Catalog) PageComments(ctx context.Context, slug string) ([]PageComment, error) {
