...
func (s *Store) Preferences(ctx context.Context, userID int64) (UserPreferences, error) {
...
func (s *Store) SavePreferences(ctx context.Context, userID int64, preferences UserPreferences) error {
