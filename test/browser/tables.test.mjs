...
const table = `<table class="lore-table-sortable lore-table-filterable lore-table-styled"><thead><tr><th class="table-tone-blue">Service</th><th>Replicas</th></tr></thead><tbody><tr><td><a href="pages/db">DB</a></td><td>10</td></tr><tr><td>API</td><td>2</td></tr></tbody></table>`;
...
test("Tables uses packaged sorting/filtering, theme colors, and semantic fallback", async () => {
  ...
  try {
    ...
    assert.equal(await page.locator("[data-lore-fallback]").isVisible(), false);
    await frame
