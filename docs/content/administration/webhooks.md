...
The JSON payload contains the event name, actor identifier, object type/key, detail, and UTC occurrence time. Page creates/updates/moves/deletes, review requests/updates/cancellations/decisions, revision restores, comments, imports, and bulk operations emit events after the primary mutation commits.
