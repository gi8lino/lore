...
Administrators can export selected pages or all pages as an archive. PDF export uses the normal Markdown renderer, inlines stored images, and invokes WeasyPrint.
